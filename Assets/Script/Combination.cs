...
public class Combination : MonoBehaviour
{
    ...
    //void compressTo(int level) {
    //    var direction = (playerB.transform.position - playerA.transform.position).normalized;
    //    playerA.transform.position += (direction * 0.1f * level);
    ...
    //void makeLevitating() {
    //    if(connectorIndex == 2) {
    //        var distance = Vector2.Distance(playerA.transform.position, playerB.transform.position);
    //        var stickLength = stick.GetComponent<Renderer>().bounds.size.x;
    //        stick.transform.localScale = new Vector3(3.0f * (3.0f / distance), 0.1f, 1f);
